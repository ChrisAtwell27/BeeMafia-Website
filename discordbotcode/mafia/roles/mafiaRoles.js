...
const ROLES = {
    ...
    QUEENS_GUARD: {
        name: "Queen's Investigator",
        emoji: '👮',
        team: 'bee',
        description: 'You are the **Queen\'s Investigator**! You can investigate one player each night to see if they are suspicious (Wasp/Neutral Evil).',
